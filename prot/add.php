	...
	<section class="page-top-section set-bg" data-setbg="img/bg/top.gif">
		<div class="page-info">
			...
			<div class="site-breadcrumb">
				<a href="admin.php">Edit Devices</a>  /
...
<section class="contact-page">
        ...
        <form action="./php/addphp.php" method="post">

        <div class="form-field">
            <label>Device ID :</label>
             <input  type="text" name="DID" placeholder="Device ID" required/>
        </div>
         <div class="form-field">
         <label>Model :</label>
...
<?php } ?>
        ...
        <div class="form-field">
             <button name="add" class="btn" type="submit">Add Device </button>
         </div>
